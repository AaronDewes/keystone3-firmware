...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"about_info_verify_firmware_desc", "This feature will help you verify that the firmware running on your keystone device is consistent with the one you downloaded."},
    {"about_info_verify_firmware_step1", "Go to Keystone's firmware update page using your computer or smartphone."},
    {"about_info_verify_firmware_step2", "Click the #F5870A Checksum# button next to the firmware download."},
    {"about_info_verify_firmware_step3", "Tap the #F5870A Show Checksum# button below and compare the info shown on the web page and your device."},
    ...
    {"usb_transport_connect_rabby", "Rabby Wallet want's to connect your Keystone via USB"},
